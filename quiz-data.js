...
Q: According to the Big Bang Theory, what is the estimated age of the universe?
A) 4.6 Billion Years
B) 13.7 Billion Years
C) 100 Billion Years
D) 6000 Years
ANS: B
Q: Who coined the term 'Geography'?
A) Herodotus
B) Eratosthenes
C) Aristotle
D) Ptolemy
ANS: B
Q: Which hypothesis explains the origin of the Solar System using a 'Nebula' (rotating cloud of dust and gases)?
A) Planetesimal Hypothesis
B) Steady State Theory
C) Nebular Hypothesis
D) Binary Theory
ANS: C
Q: Who proposed the 'Steady State Theory' in 1948, suggesting the universe is constantly expanding but maintaining average density?
A) Edwin Hubble
B) Georges Lemaître
C) Fred Hoyle, Hermann Bondi, and Thomas Gold
D) Immanuel Kant
ANS: C
Q: Which scientist provided evidence that the universe is constantly expanding?
A) Isaac Newton
B) Edwin Hubble
C) Albert Einstein
D) Stephen Hawking
ANS: B
Q: The 'Planetesimal Hypothesis' or Binary Theory, involving an encounter between the Sun and another star, was proposed by:
A) Kant and Laplace
B) Chamberlin and Moulton
C) Hubble and Humason
D) Hoyle and Gold
ANS: B
Q: Who was the first to propose the 'Heliocentric Model' in the 16th century, stating the Sun is at the center?
A) Ptolemy
B) Nicolaus Copernicus
C) Galileo Galilei
D) Johannes Kepler
ANS: B
Q: What percentage of the total mass of the Solar System is contained within the Sun?
A) 50%
B) 75%
C) 90%
D) 99%
ANS: D
Q: Objects that shine by their own light, like the Sun, are called:
A) Non-luminous
B) Luminous
C) Reflective
D) Opaque
ANS: B
Q: The 'Asteroid Belt' is located between the orbits of which two planets?
A) Earth and Mars
B) Mars and Jupiter
C) Jupiter and Saturn
D) Saturn and Uranus
ANS: B
Q: What is the term for a meteoroid that survives its passage through the Earth's atmosphere and hits the ground?
A) Meteor
B) Meteorite
C) Asteroid
D) Comet
ANS: B
Q: Which lake in Maharashtra is believed to be a crater lake formed by a meteorite impact?
A) Chilika Lake
B) Sambhar Lake
C) Lonar Lake
D) Wular Lake
ANS: C
Q: The 'Oort Cloud' is located:
A) Between Mars and Jupiter
B) Beyond the Kuiper Belt
C) Just beyond Neptune
...
D) Cygnus
ANS: C
Q: Which star is the nearest to Earth after the Sun?
A) Sirius
B) Proxima Centauri
C) Alpha Centauri A
D) Betelgeuse
ANS: B
Q: By which process does the Sun generate its energy?
A) Nuclear Fission
B) Nuclear Fusion
C) Chemical Combustion
D) Gravitational Collapse
ANS: B
Q: The visible surface of the Sun is called the:
A) Corona
B) Chromosphere
C) Photosphere
D) Core
ANS: C
Q: Which phenomenon on the Sun involves a burst of plasma and magnetic fields released into space (CME)?
A) Solar Flare
B) Sunspot
C) Coronal Mass Ejection
D) Solar Wind
ANS: C
Q: Auroras that occur in the Northern Hemisphere are called:
A) Aurora Australis
B) Aurora Borealis
C) Solar Flares
D) Magnetic Storms
ANS: B
Q: Which group of planets are considered 'Terrestrial' or 'Inner' planets?
A) Jupiter, Saturn, Uranus, Neptune
B) Mercury, Venus, Earth, Mars
C) Earth, Mars, Jupiter, Saturn
D) Mercury, Venus, Earth, Jupiter
ANS: B
Q: Which planet is the smallest and closest to the Sun?
A) Venus
B) Mars
C) Mercury
D) Pluto
ANS: C
Q: Which planet is known as the 'Hottest Planet' due to its thick carbon dioxide atmosphere?
A) Mercury
B) Venus
C) Mars
D) Jupiter
ANS: B
Q: Which two planets rotate from East to West (Retrograde)?
A) Mercury and Venus
B) Earth and Mars
C) Venus and Uranus
...
D) Venus
ANS: C
Q: Which planet is known as the 'Red Planet' due to iron oxide in its soil?
A) Venus
B) Mars
C) Jupiter
D) Saturn
ANS: B
Q: Which is the largest volcano/mountain in the Solar System, located on Mars?
A) Mount Everest
B) Mauna Kea
C) Olympus Mons
D) Maxwell Montes
ANS: C
Q: Which planet has the fastest rotation (shortest day) in the Solar System?
A) Mercury
B) Earth
C) Jupiter
D) Saturn
ANS: C
Q: Which planet is the least dense and would float on water?
A) Jupiter
B) Saturn
C) Uranus
D) Neptune
ANS: B
Q: Which planet was the first to be discovered by mathematical prediction?
A) Uranus
B) Neptune
C) Pluto
D) Saturn
...
D) Makemake
ANS: C
Q: The 'Big Dipper' is an asterism part of which constellation?
A) Ursa Minor
B) Ursa Major
C) Orion
D) Scorpio
ANS: B
Q: Which planet has no moons?
A) Mars
B) Neptune
C) Mercury
D) Uranus
ANS: C
Q: Who was the second person to step on the Moon after Neil Armstrong?
A) Michael Collins
B) Yuri Gagarin
C) Edwin 'Buzz' Aldrin
D) Rakesh Sharma
ANS: C
Q: 'Saptarishi' is the Indian name for which constellation/asterism?
A) Orion
B) Big Dipper (Ursa Major)
C) Cassiopeia
D) Pleiades
ANS: B
Q: Which planet takes the longest time to revolve around the Sun?
A) Saturn
B) Uranus
C) Neptune
D) Pluto
...
D) Betelgeuse
ANS: B
Q: What is the estimated distance between L2 and L3 Lagrange points in the Sun-Earth system?
A) ~15 Lakh km
B) ~30 Crore km
C) ~32 Crore km
D) ~15 Crore km
ANS: C
Q: Which constellation has a distinctive 'W' or 'M' shape?
A) Orion
B) Cassiopeia
C) Cygnus
D) Leo
ANS: B
Q: Which planet rotates on its side, having an axial tilt of about 98 degrees?
A) Venus
B) Mars
C) Uranus
D) Neptune
ANS: C
Q: Clouds of Sulfuric Acid are found in the atmosphere of:
A) Venus
B) Jupiter
C) Saturn
D) Uranus
ANS: A
Q: Triton is the largest moon of which planet?
A) Saturn
B) Uranus
C) Neptune
D) Jupiter
ANS: C
Q: Which star is known as the 'Pole Star' or 'North Star'?
A) Sirius
B) Polaris
C) Vega
D) Alpha Centauri
...
D) Earth
ANS: C
Q: Who calculated the existence of Neptune based on disturbances in Uranus's orbit?
A) Galileo
B) Newton
C) Le Verrier and Galle
D) Hubble
ANS: C
Q: The expansion of the Universe was proposed by:
A) Albert Einstein
B) Edwin Hubble
C) Isaac Newton
D) Kepler
...
D) Mars
ANS: B
Q: Cross-shaped constellation is:
A) Orion
B) Cygnus
C) Cassiopeia
D) Ursa Major
ANS: B
Q: Makemake, a dwarf planet, completes one revolution around the Sun in approximately:
A) 248 Years
B) 310 Years
C) 165 Years
D) 88 Days
ANS: B
Q: In the Sun-Earth system, the Sun, Earth, and L4 point form which type of triangle?
A) Isosceles
B) Equilateral
C) Scalene
D) Right-angled
...
Q: What is the accepted age of the Earth according to the last CGL Mains exam, as discussed in the lecture?
A) 4.7 Billion Years
B) 4.6 Billion Years
C) 4.5 Billion Years
D) 13.7 Billion Years
ANS: C
Q: Which method is used to determine the age of the Earth?
A) Stratigraphy
B) Radio-carbon Dating
C) Radioactive Dating
D) Dendrochronology
ANS: C
Q: The Earth's shape is best described as a Geoid or:
A) Perfect Sphere
B) Oblate Spheroid
C) Prolate Spheroid
D) Flat Disc
ANS: B
Q: What is the reason for the Earth bulging at the Equator and being flattened at the Poles?
A) Gravitational Pull of the Moon
B) Centrifugal Force due to Rotation
C) Earth's Magnetic Field
D) Tectonic Plate Movement
ANS: B
Q: What is the precise time the Earth takes to complete one rotation on its axis?
A) 24 hours
B) 23 hours 56 minutes 4 seconds
C) 24 hours 4 minutes
D) 23 hours 56 minutes
ANS: B
Q: What is the primary result of the Earth's rotation?
A) Seasons
B) Tides
C) Day and Night
D) Annual Weather Cycles
ANS: C
Q: The Earth's axis is tilted by how many degrees from the perpendicular to its orbital plane?
A) 66.5 degrees
B) 21.5 degrees
C) 23.5 degrees
D) 90 degrees
ANS: C
Q: What is the approximate distance between any two consecutive degrees of latitude?
A) 100 km
B) 111 km
C) 150 km
D) 165 km
ANS: B
Q: What is the total number of lines of Latitude (or Parallels) drawn on the globe?
A) 90
B) 179
C) 180
D) 181
ANS: D
Q: What is the total number of Latitudinal Circles (excluding the North and South Poles which are points)?
A) 181
B) 179
C) 180
D) 360
ANS: B
Q: The region on Earth where the Sun's direct rays never travel beyond, located between the Tropics of Cancer and Capricorn, is called the:
A) Frigid Zone
B) Temperate Zone
C) Torrid Zone
D) Antarctic Zone
ANS: C
Q: The Frigid Zones (beyond the Arctic and Antarctic Circles) experience long periods of continuous daylight and darkness, which can last for up to:
A) 1 month
B) 3 months
C) 6 months
D) 12 months
ANS: C
Q: Which line of latitude divides the Earth into the Northern and Southern Hemispheres?
A) Prime Meridian
B) Tropic of Cancer
C) Equator
D) International Date Line
ANS: C
Q: What is the line of Longitude that serves as the reference point (0 degrees) for global time zones?
A) International Date Line (IDL)
B) Indian Standard Meridian (ISM)
C) Prime Meridian (GMT)
D) Equator
ANS: C
Q: The maximum distance between two lines of Longitude occurs at the:
A) North Pole
B) South Pole
C) Equator
D) Tropic of Cancer
ANS: C
Q: What is the maximum distance between two lines of Longitude at the Equator?
A) 111 km
B) 111.32 km
C) 0 km
D) 150 km
ANS: B
Q: What is the minimum distance between two lines of Longitude (at the Poles)?
A) 111.32 km
B) 111 km
C) 55.6 km
D) 0 km
ANS: D
Q: The total number of degrees of Longitude is:
A) 180
B) 360
C) 361
D) 359
...
D) 45 degrees
ANS: B
Q: For every 1 degree of Longitude, the time difference is equivalent to:
A) 1 minute
B) 4 minutes
C) 15 minutes
D) 1 hour
ANS: B
Q: The Prime Meridian (GMT) passes through which European city's observatory?
A) Paris
B) Rome
C) Berlin
D) Greenwich (London)
ANS: D
Q: Which group of countries does the Prime Meridian NOT pass through (based on the BSF GAME in Togo Kingdom mnemonic)?
A) France, Ghana, Mali
B) Spain, Algeria, UK
C) Burkina Faso, Togo, Spain
D) India, Pakistan, China
ANS: D
Q: How many hours ahead is Indian Standard Time (IST) from Greenwich Mean Time (GMT)?
...
A) Any circle on the Earth with a large circumference.
B) A circle that divides the Earth into two equal halves.
C) Only the Equator.
D) Only the Longitudes.
ANS: B
Q: Which statement regarding Great Circles is correct?
A) All lines of Latitude are Great Circles.
B) Only the Prime Meridian is a Great Circle.
C) All lines of Longitude are Great Circles.
D) The Tropic of Cancer is a Great Circle.
ANS: C
Q: A Great Circle path represents the:
A) Longest possible distance between two points.
B) Shortest possible distance between two points.
C) Constant distance path between two points.
D) Path along the Equator.
ANS: B
...
D) Ellipsis
ANS: C
Q: The Earth's path around the Sun is known as a(n):
A) Circular orbit
B) Parabolic path
C) Elliptical orbit
D) Hyperbolic path
ANS: C
Q: What is the total time the Earth takes to complete one revolution around the Sun (resulting in a Leap Year every 4 years)?
A) 365 days
B) 365 days 6 hours
C) 365 days 6 hours 9 minutes
D) 365 days 4 hours
ANS: C
Q: What are the two primary factors responsible for the occurrence of seasons?
A) Rotation and Tides
B) Tides and Revolution
...
D) December 22
ANS: D
Q: The days on which the Sun's direct rays fall upon the Equator, resulting in equal day and night across the globe, are called:
A) Solstices
B) Equinoxes
C) Perihelion
D) Aphelion
ANS: B
Q: Which date is associated with the Vernal (Spring) Equinox?
A) March 21
B) June 21
C) September 23
D) December 22
ANS: A
Q: Which date is associated with the Autumnal (Fall) Equinox?
A) March 21
B) June 21
C) September 23
D) December 22
...
D) Earth-Sun-Moon
ANS: A
Q: On which Moon phase do Solar Eclipses always occur?
A) Full Moon (Purnima)
B) Half Moon
C) Crescent Moon
D) New Moon (Amavasya)
ANS: D
Q: On which Moon phase do Lunar Eclipses always occur?
A) Full Moon (Purnima)
B) Half Moon
C) Crescent Moon
D) New Moon (Amavasya)
...
A) When the Moon appears blue in the sky.
B) The second Full Moon occurring within a single calendar month.
C) The Moon on the night of the Winter Solstice.
D) The Moon closest to Earth (Perigee).
ANS: B
Q: What is the cause of 'Tides' (the rise and fall of sea level)?
A) Wind and Waves
B) Earth's Rotation
C) Gravitational pull of the Moon and Sun
D) Ocean Currents
ANS: C
Q: Tides that occur when the Sun, Earth, and Moon are in a straight line (Syzygy), resulting in the highest high tides, are called:
A) Neap Tides
B) Ebb Tides
C) Spring Tides
D) Flood Tides
ANS: C
Q: Tides that occur when the Sun, Earth, and Moon form a 90-degree angle (Quadrature), resulting in the lowest high tides, are called:
A) Spring Tides
B) Neap Tides
C) Ebb Tides
D) Flood Tides
ANS: B
Q: The total number of 'Great Circles' (Longitudes and Equator only) on Earth is:
A) 180
B) 181
C) 360
D) 361
...
D) France
ANS: D
Q: The arc/line connecting points of equal travel time from a common center is known as: (PYQ discussed at the end)
A) Isobar
B) Isotherm
C) Isobront
D) Isochrone
ANS: D
Q: Which zone near the Equator receives direct and intense sunlight (PYQ)?
A) Frigid Zone
B) Temperate Zone
C) Torrid Zone
D) Polar Zone
ANS: C
Q: How many minutes does it take for Moon light to reach Earth? (Fact from lecture)
A) 8.3 minutes
B) 1.3 seconds
C) 1 minute
D) 5 minutes
...
[SUBJECT: Geography]
[CHAPTER: Earth's Interior and Plate Tectonic]
Q: The scientific study of the Earth, including its composition, structure, and the processes that shape it, is called:
A) Geography
B) Cartography
C) Geology
D) Geodesy
ANS: C
Q: Who is considered the Father of Geology?
A) Alfred Wegener
B) James Hutton
C) Arthur Holmes
D) Charles Darwin
ANS: B
Q: What is the mean radius of the Earth?
A) 6378 km
B) 6371 km
C) 5515 km
D) 6400 km
ANS: B
Q: The deepest man-made bore hole in the world, dug for research purposes, reached a depth of approximately:
A) 5 km
B) 12.3 km
C) 30 km
D) 50 km
ANS: B
Q: What is the primary method used to gain indirect information about the Earth's interior?
A) Deep mining samples
B) Volcanic eruptions
C) Earthquake (Seismic) waves
D) Drilling boreholes
ANS: C
Q: The three primary layers of the Earth's interior, from outside to inside, are:
A) Mantle, Crust, Core
B) Core, Mantle, Crust
C) Crust, Mantle, Core
D) Lithosphere, Asthenosphere, Core
ANS: C
Q: Which layer of the Earth's interior is the thinnest?
A) Crust
B) Mantle
C) Outer Core
D) Inner Core
ANS: A
Q: The outermost layer of the Earth, the Crust, is composed of two types: Continental and Oceanic. Which one is thicker?
A) Oceanic Crust
B) Continental Crust
C) Both have the same thickness
D) Thickness varies randomly
ANS: B
Q: The mean thickness of the Oceanic Crust is approximately:
A) 30 km
B) 15 km
C) 5 km
D) 100 km
ANS: C
Q: The mean thickness of the Continental Crust is approximately:
A) 5 km
B) 15 km
C) 30 km
D) 70 km
ANS: C
Q: The Oceanic Crust is primarily composed of Basaltic Rock, which makes it:
A) Lighter and Thicker
B) Denser and Thinner
C) Lighter and Thinner
D) Denser and Thicker
ANS: B
Q: The Continental Crust is primarily composed of which type of rock?
A) Basaltic Rock
B) Peridotite Rock
C) Granitic Rock
D) Sedimentary Rock
ANS: C
Q: The outermost layer of the Earth, the Crust, is brittle in nature. What is its approximate average density?
A) 5.5 g/cm³
B) 3.3 g/cm³
C) 2.7 g/cm³
D) 8.1 g/cm³
ANS: C
Q: What is the composition of the Continental Crust, often referred to as 'Sial'?
A) Silicon and Magnesium
B) Silicon and Aluminium
C) Sulphur and Aluminium
D) Silica and Iron
ANS: B
Q: What is the composition of the Oceanic Crust, often referred to as 'Sima'?
A) Silicon and Aluminium
B) Sulphur and Magnesium
C) Silicon and Magnesium
D) Sodium and Magnesium
ANS: C
Q: The Lithosphere (Stalamandal) is composed of:
A) The entire Crust only
B) The entire Mantle only
C) The entire Crust and the entire Mantle
D) The entire Crust and the Upper Solid Part of the Mantle
ANS: D
Q: What is the maximum depth that the Lithosphere (Stalamandal) can extend to?
A) 100 km
B) 400 km
C) 2900 km
D) 200 km
ANS: D
Q: The layer just beneath the Lithosphere, known as the 'Zone of Weakness' or 'Asthenosphere', is characterized by being in a:
A) Solid state
B) Liquid state
C) Semi-molten (plastic) state
D) Gaseous state
ANS: C
Q: The Asthenosphere is part of which main layer of the Earth's interior?
A) Crust
B) Lower Mantle
C) Upper Mantle
D) Outer Core
ANS: C
Q: What is the primary source of Magma or Lava that leads to volcanic eruptions?
A) Inner Core
B) Lower Mantle
C) Asthenosphere
D) Lower Crust
ANS: C
Q: What is the maximum depth that the Mantle layer extends to?
A) 400 km
B) 2900 km
C) 5100 km
D) 6371 km
ANS: B
Q: The Earth's core is primarily composed of 'NiFe', which stands for:
A) Nickel and Ferrite
B) Nitrogen and Iron
...
ANS: C
Q: The Earth's Magnetic Field is primarily generated by:
A) The movement of the solid Inner Core
B) The movement of molten Nickel and Iron in the Liquid Outer Core
C) Tidal forces acting on the Mantle
D) Plate tectonic activity in the Lithosphere
ANS: B
Q: Which layer accounts for the largest mass percentage of the Earth's total interior?
A) Crust
B) Mantle
C) Outer Core
D) Inner Core
ANS: B
Q: What is the mass percentage of the Mantle?
A) 1%
B) 31%
C) 68%
D) 84%
ANS: C
Q: What is the volume percentage of the Mantle?
A) 31%
B) 68%
C) 84%
D) 15%
ANS: C
Q: In terms of composition, which element is the MOST abundant element in the Earth's crust?
A) Silicon
B) Iron
C) Aluminium
D) Oxygen
ANS: D
Q: In terms of composition, which element is the MOST abundant METAL in the Earth's crust?
A) Iron
B) Calcium
C) Aluminium
D) Sodium
ANS: C
Q: The boundary separating the Upper Crust and the Lower Crust is called the:
A) Repetti Discontinuity
B) Mohorovicic Discontinuity
C) Conrad Discontinuity
D) Lehman Discontinuity
ANS: C
Q: The boundary separating the entire Crust from the Mantle is called the:
A) Gutenberg Discontinuity
B) Repetti Discontinuity
C) Mohorovicic (Moho) Discontinuity
D) Conrad Discontinuity
ANS: C
Q: The boundary separating the Upper Mantle from the Lower Mantle is called the:
A) Lehman Discontinuity
B) Gutenberg Discontinuity
C) Mohorovicic Discontinuity
D) Repetti Discontinuity
ANS: D
Q: The boundary separating the Mantle from the Core is called the:
A) Gutenberg Discontinuity
B) Conrad Discontinuity
C) Lehman Discontinuity
D) Mohorovicic Discontinuity
ANS: A
Q: The boundary separating the Outer Core from the Inner Core is called the:
A) Mohorovicic Discontinuity
B) Gutenberg Discontinuity
C) Lehman Discontinuity
D) Repetti Discontinuity
ANS: C
Q: The theory that suggests the Earth's lithosphere is broken into large, rigid plates that move and interact with each other is called:
A) Continental Drift Theory
B) Convection Current Theory
C) Plate Tectonics Theory
D) Sea Floor Spreading Theory
ANS: C
Q: Who first proposed the Plate Tectonics Theory in 1967?
A) Arthur Holmes and Alfred Wegener
B) Mackenzie and Parker
C) Hess and Dietz
D) Gutenberg and Lehman
ANS: B
Q: The movement of the tectonic plates is generally:
A) Very fast (several meters per year)
B) Slow (a few centimeters per year)
C) Intermittent and random
D) Non-existent; the plates are static
ANS: B
Q: The Earth's lithospheric plates move primarily because of convection currents originating in which layer?
A) Lower Crust
B) Lower Mantle
C) Asthenosphere
D) Inner Core
ANS: C
Q: How many major tectonic plates are there?
A) 6
B) 7
C) 8
D) 12
ANS: B
Q: Which of the following is the largest tectonic plate?
...
D) Plates slide past each other without interaction.
ANS: B
Q: The zone where one tectonic plate sinks beneath another at a Convergent boundary is called a:
A) Transform Zone
B) Convergent Zone
C) Subduction Zone
D) Divergent Zone
ANS: C
Q: Which type of plate boundary is generally 'Neither Constructive nor Destructive'?
A) Divergent Boundary
B) Convergent Boundary
C) Subduction Zone
D) Transform Boundary
ANS: D
Q: Earthquakes are most frequently associated with which type of plate boundary, due to plates locking up and suddenly releasing energy?
A) Divergent Boundary
B) Convergent Boundary
C) Subduction Zone
D) Transform Boundary
ANS: D
Q: The point inside the Earth where an earthquake originates and energy is suddenly released is called the:
A) Epicenter
B) Focus (Hypocenter)
C) Fault Line
D) Seismic Zone
ANS: B
Q: The point on the Earth's surface directly above the Focus (Hypocenter) where destruction is often maximized is called the:
A) Fault Line
B) Hypocenter
C) Epicenter
D) Seismic Zone
ANS: C
Q: Which type of natural disaster is a Japanese term meaning 'Harbor Waves'?
A) Cyclone
B) Tsunami
C) Typhoon
D) Hurricane
ANS: B
Q: A Tsunami is caused when an earthquake occurs at the sea floor, provided there is a:
A) Horizontal plate displacement
B) Convergent boundary only
C) Vertical plate displacement
D) Subduction zone only
ANS: C
Q: The seismic effect where water-saturated soil loses its strength and behaves like a liquid is called:
A) Landslide
B) Avalanche
C) Faulting
D) Soil Liquefaction
ANS: D
Q: All natural earthquakes occur in which layer of the Earth?
A) Crust
B) Mantle
C) Outer Core
D) Lithosphere
...
D) Arctic Ocean
ANS: C
Q: Approximately what percentage of the world's earthquakes occur in the Pacific Ring of Fire?
A) 50%
B) 75%
C) 80%
D) 90%
ANS: D
Q: The region that experiences volcanic activity but is NOT part of the Pacific Ring of Fire (e.g., Hawaii) is called a:
A) Subduction Zone
B) Divergent Ridge
C) Volcanic Hotspot
D) Transform Fault
ANS: C
Q: Which country experienced the strongest recorded earthquake in the 20th century (9.5 Magnitude in 1960)?
A) Japan
B) Chile
C) USA
D) Indonesia
ANS: B
Q: What is the second name given to the Focus of an earthquake?
A) Epicenter
B) Hypocenter
C) Fault Line
D) Seismic Zone
...
[SUBJECT: Geography]
[CHAPTER: Rocks, Continents and Oceans]
Q: Who first proposed the idea that continents were once joined together, predating Alfred Wegener's formal theory?
A) Harry Hess
B) Arthur Holmes
C) Abraham Ortelius
D) Tuzo Wilson
...
D) James Hutton
ANS: B
Q: The single landmass (mega-continent) that existed over 200 million years ago, according to the Continental Drift Theory, was named:
A) Panthalassa
B) Gondwanaland
C) Laurasia
D) Pangaea
ANS: D
Q: The massive single ocean surrounding the mega-continent Pangaea was named:
A) Tethys Sea
B) Panthalassa
C) Pacific Ocean
D) Gondwana Ocean
ANS: B
Q: Pangaea split into two major parts: the northern part was called Laurasia, and the southern part was called:
A) Angaraland
B) Gondwanaland
C) Eurasianland
D) Tethys
ANS: B
Q: How long ago did the major drifting of continents begin, according to the lecture?
A) 50 million years ago
B) 100 million years ago
C) 200 million years ago
D) 4.5 billion years ago
ANS: C
Q: Which of the following is NOT an evidence for Continental Drift mentioned in the lecture?
A) Jigsaw Fit of the Coastlines
B) Fossil Deposits across oceans
C) Rock of Same Age across oceans
D) Variation in Earth's Gravity
ANS: D
Q: The presence of Gold (Placer) Deposits in Ghana (Africa) that originate from Gold veins found in South America suggests:
A) Active trade routes
B) Migration of mining technology
C) The continents were once joined
D) A shared magnetic pole
ANS: C
Q: Glacial sedimentary deposits that provide evidence of continental drift, found in India and five other continents, are called:
A) Tillite Deposits
B) Loess Deposits
C) Moraine Deposits
D) Alluvial Deposits
ANS: A
Q: India was a part of which ancient supercontinent?
A) Laurasia
B) Gondwanaland
C) Angaraland
D) Pangaea
ANS: B
Q: What was the primary force Alfred Wegener suggested was responsible for continental drift (which was later proven incorrect)?
A) Convection Currents
B) Tidal Forces and Polar Fleeing Force
C) Volcanic Activity
...
D) Mackenzie and Parker (1967)
ANS: C
Q: The movement of tectonic plates is caused by Convection Cells developing in which semi-molten layer of the Earth?
A) Lithosphere
B) Inner Core
C) Asthenosphere
D) Lower Mantle
ANS: C
Q: The heat driving the convection currents in the Asthenosphere comes from two main sources: Residual Heat and:
A) Solar Radiation
B) Tidal Energy
C) Radioactive Decay of elements
D) Chemical Reactions
ANS: C
Q: Which type of plate boundary is generally associated with the formation of new oceanic crust (Constructive Boundary)?
A) Convergent Boundary
B) Transform Boundary
C) Subduction Zone
D) Divergent Boundary
ANS: D
Q: The process by which new oceanic crust is formed at the mid-ocean ridges due to the divergence of plates is called:
A) Continental Drift
...
B) Harry Hess
C) Arthur Holmes
D) Mackenzie and Parker
ANS: B
Q: The age of oceanic crustal rock increases as you move:
A) Closer to the continental margin
B) Towards the trench
C) Away from the Mid-Oceanic Ridge
D) Towards the Equator
ANS: C
Q: Rocks found equidistant from the Mid-Oceanic Ridge crest will have:
A) Different magnetic properties
B) The same age and magnetic properties
C) Opposite ages
...
D) Oceanic Crust forms from light sedimentary deposits
ANS: B
Q: What is the largest and longest continuous landform on Earth?
A) The Himalayas
...
D) Both plates are too dense.
ANS: B
Q: The deepest point in the world's oceans, the Mariana Trench, is located in the:
A) Indian Ocean
B) Atlantic Ocean
C) Pacific Ocean
D) Southern Ocean
ANS: C
Q: The deepest point in the Indian Ocean is the:
A) Mariana Trench
B) Puerto Rico Trench
C) Java Trench (Sunda Trench)
D) Challenger Deep
ANS: C
Q: The deepest point in the Atlantic Ocean is the:
A) Java Trench
B) Puerto Rico Trench (Milwaukee Deep)
C) Mariana Trench
D) Aleutian Trench
ANS: B
Q: The gentle, sloping area extending from the continent beneath the ocean water, where oil and gas are often extracted, is called the:
A) Continental Slope
B) Continental Rise
C) Abyssal Plain
D) Continental Shelf
ANS: D
Q: The steep slope beyond the Continental Shelf is called the:
A) Continental Rise
B) Continental Slope
C) Abyssal Plain
D) Oceanic Ridge
ANS: B
Q: The most level and extensive part of the ocean floor, often called the deep sea plain, is the:
A) Continental Shelf
B) Continental Rise
C) Continental Slope
D) Abyssal Plain
...
D) Iceberg of the Ocean
ANS: A
Q: Corals exist in a symbiotic relationship with which organism?
A) Phytoplankton
B) Zoo-xanthellae algae
C) Seaweed
D) Bivalves
ANS: B
Q: Corals primarily secrete which substance to form their hard skeletons and colonies?
A) Silicon Dioxide
B) Magnesium Sulphate
C) Calcium Carbonate
D) Sodium Chloride
ANS: C
Q: A coral reef that forms immediately adjacent to the coast of a landmass is a:
A) Atoll
B) Barrier Reef
C) Fringing Reef
D) Lagoon Reef
ANS: C
Q: A ring-shaped coral reef that completely or partially encloses a lagoon, formed when a central island sinks, is called an:
A) Fringing Reef
B) Barrier Reef
C) Atoll
D) Guyot
ANS: C
Q: What is the required condition for coral growth?
A) Deep, cold water
B) Fresh (non-saline) water
C) Clear, shallow, saline water
D) Muted and muddy water
ANS: C
Q: What is the term for the process where corals expel their symbiotic algae due to rising sea temperatures, causing the coral to turn white?
...
C) Lakshadweep Reef
D) Andaman and Nicobar Reef
ANS: B
Q: Which is the third largest ocean in the world, named after a country?
A) Atlantic Ocean
B) Pacific Ocean
C) Indian Ocean
D) Arctic Ocean
ANS: C
Q: Which is the largest ocean in the world, by area and depth?
A) Atlantic Ocean
B) Pacific Ocean
C) Indian Ocean
D) Southern Ocean
ANS: B
Q: The 'Saragasso Sea', known as the only sea without a land boundary, is located in the:
A) North Pacific Ocean
B) South Indian Ocean
C) North Atlantic Ocean
D) Southern Ocean
ANS: C
Q: According to the 'money' mnemonic taught in the lecture, the order of oceans from largest to smallest is:
A) Pacific, Atlantic, Indian, Southern, Arctic
B) Atlantic, Pacific, Indian, Southern, Arctic
...
D) Gulf of Mannar
ANS: C
Q: The Bay of Bengal is an extension of which ocean?
A) Pacific Ocean
B) Atlantic Ocean
C) Southern Ocean
D) Indian Ocean
ANS: D
Q: The Arabian Sea is an extension of which ocean?
A) Pacific Ocean
B) Atlantic Ocean
C) Indian Ocean
D) Southern Ocean
ANS: C
Q: The depth of the oceanic crust beneath the ocean floor extends approximately: (PYQ discussed at the end)
A) 1-2 km
B) 2-5 km
C) 5-10 km
D) 10-15 km
...
[SUBJECT: Geography]
[CHAPTER: Rocks and Volcanoes]
Q: The small, steep-sided volcanoes primarily formed by moderately explosive eruptions where pyroclastic debris and ash outweigh the lava are called:
A) Shield Volcanoes
B) Composite Volcanoes
C) Cinder Cone Volcanoes
D) Caldera
ANS: C
Q: Which type of plate boundary is primarily associated with the formation of Fissure Volcanoes (where lava spreads widely without building a cone)?
A) Convergent Boundary
B) Transform Boundary
C) Subduction Zone
D) Divergent Boundary
ANS: D
Q: What is the term for the large, bowl-shaped depression formed when a volcano's cone collapses inward after a massive eruption?
A) Crater
B) Vent
C) Caldera
D) Batholith
...
D) High silica content, high viscosity, high temperature
ANS: A
Q: Which type of lava (Acidic or Basic) typically spreads over a larger area due to its fluid, non-viscous nature?
A) Acidic
B) Basic
...
C) Basic (Basaltic)
D) Felsic (High Silica)
ANS: C
Q: Which type of volcano is characterized by a very broad, gently sloping profile and is built from successive flows of highly fluid (basic) lava?
A) Composite Volcano
B) Cinder Cone Volcano
C) Stratovolcano
D) Shield Volcano
ANS: D
Q: Which of the following is an example of a Shield Volcano and a Volcanic Hotspot?
A) Mount Fuji, Japan
B) Mount Cotopaxi, Ecuador
...
D) Rare explosive eruptions
ANS: B
Q: The highest volcano in the world is located on the border between Chile and Argentina and is named:
A) Mauna Loa
B) Mount Chimborazo
C) Ojos del Salado
D) Mount Fuji
ANS: C
Q: Volcanoes are categorized based on their eruption frequency. Which type has erupted in the past, is currently quiet, but may erupt again?
A) Extinct
B) Dormant
C) Active
D) Fissure
ANS: B
Q: The study of rocks, including their origin, classification, and composition, is called:
A) Seismology
B) Paleontology
C) Petrology
D) Lithology
...
D) Basaltic Rock
ANS: C
Q: Igneous rocks that solidify deep within the Earth's crust, forming large crystals due to slow cooling, are called:
A) Extrusive Igneous (Volcanic)
B) Intrusive Igneous (Plutonic)
C) Sedimentary
D) Metamorphic
ANS: B
Q: Igneous rocks that solidify quickly on the Earth's surface after eruption, forming fine-grained crystals, are called:
A) Intrusive Igneous (Plutonic)
B) Extrusive Igneous (Volcanic)
C) Metamorphic
D) Gneiss
ANS: B
...
D) Diorite
ANS: C
Q: A large, irregular mass of intrusive igneous rock that solidifies deep beneath the Earth's surface and is only exposed by erosion and uplift is called a:
A) Dike
B) Sill
C) Laccolith
D) Batholith
...
D) Subduction and melting of old rock
ANS: C
Q: The process by which loose sediments are transformed into a solid sedimentary rock is known as:
A) Metamorphism
B) Lithification
C) Erosion
D) Crystallization
...
D) Coal
ANS: C
Q: Which type of rock is formed when existing rocks (igneous or sedimentary) are transformed by intense heat, pressure, or volume changes (PVT)?
A) Primary Rock
B) Igneous Rock
C) Metamorphic Rock
D) Sedimentary Rock
ANS: C
Q: The change of rock form without significant chemical change, driven mainly by extreme pressure (e.g., during plate collision), is called:
A) Thermal Metamorphism
B) Dynamic Metamorphism
C) Contact Metamorphism
D) Regional Metamorphism
ANS: B
Q: The transformation of rock due to extreme heat from proximity to magma or lava is specifically called:
A) Dynamic Metamorphism
B) Regional Metamorphism
C) Contact Metamorphism
D) Recrystallization
ANS: C
Q: The transformation of rock over a large area due to immense pressure and heat from deep burial or mountain building is specifically called:
...
D) Basalt
ANS: C
Q: The cyclic process that shows how one rock type can be transformed into another (e.g., sedimentary to metamorphic, or igneous to sedimentary) is called the:
A) Rock Transformation Loop
B) Plate Tectonics Cycle
C) Rock Cycle
...
D) Quartz
ANS: D
Q: The most abundant mineral group in the Earth's crust, constituting about half of its composition, is:
A) Quartz
B) Mica
C) Pyroxene
D) Feldspar
ANS: D
Q: Which mineral makes up about 10% of the Earth's crust and is typically green or black?
A) Quartz
B) Amphibole
C) Pyroxene
D) Olivine
ANS: C
Q: Which mineral, used in radio and radar equipment, is noted for its low electrical conductivity and piezometric properties?
A) Olivine
B) Pyroxene
C) Mica
D) Quartz
ANS: C
Q: Which mineral is a greenish crystal primarily composed of Magnesium, Iron, and Silica, often used in jewelry?
A) Quartz
B) Pyroxene
C) Olivine
D) Amphibole
...
D) Quartzite
ANS: C
Q: The scale used to measure the hardness of minerals is the:
A) Richter Scale
B) Mercalli Scale
C) Mohs Scale
D) Beaufort Scale
ANS: C
Q: The softest known mineral, often used in talcum powder, is:
A) Mica
B) Quartz
C) Talc
D) Gypsum
ANS: C
Q: Which type of mineral does not contain Iron (Fe)?
A) Ferrous Metal
B) Precious Metal
C) Non-Ferrous Metal
D) Metallic Mineral
ANS: C
Q: The intrusive igneous rock is also known by what other term?
A) Volcanic Rock
B) Plutonic Rock
C) Stratified Rock
D) Clastic Rock
...
[SUBJECT: Geography]
[CHAPTER: Geomorphology and Landforms]
Q: The study of the Earth's surface and the processes that create the various landforms and topography is called:
A) Geology
B) Seismology
C) Geomorphology
D) Glaciology
...
D) Exogenic Forces
ANS: D
Q: The general process of 'wearing down' or 'destruction' of the Earth's surface features by exogenic agents is known as:
A) Diastrophism
B) Denudation
C) Volcanism
D) Orogeny
...
D) Exfoliation
ANS: D
Q: What is the main driving force behind Mass Movement?
A) Wind Energy
B) Water Velocity
...
D) Fluvial Mass Movement
ANS: C
Q: The type of physical weathering where curved rock layers peel off layer by layer due to continuous expansion and contraction (e.g., thermal stress) is called:
A) Carbonation
B) Exfoliation
C) Oxidation
D) Hydration
...
ANS: C
Q: Which geological agent is responsible for creating landforms in the form of V-shaped Valleys, Gorges, and Canyons?
A) Glacier
B) Wind
C) River Water
D) Sea Waves
...
D) Delta Stage
ANS: A
Q: The snake-like bends or loops in the course of a river, typical of the Mature and Old stages, are called:
A) Delta
B) Levees
C) Meanders
D) Plunge Pool
ANS: C
Q: A crescent-shaped lake formed when a river cuts across a meander neck, isolating the loop, is called a:
A) Plunge Pool
B) Delta
C) Oxbow Lake
D) Lagoon
ANS: C
Q: What is the depositional landform created by a river at the foot of a slope, typically in a fan shape, where its velocity suddenly decreases?
A) Floodplain
B) Delta
C) Alluvial Fan
D) Levees
ANS: C
Q: The natural embankments or raised banks formed along the sides of a river channel, primarily due to deposition during floods, are known as:
A) Oxbow Lakes
B) Alluvial Fans
C) Natural Levees
D) River Terraces
ANS: C
Q: Which agent is primarily responsible for creating U-shaped Valleys, Hanging Valleys, and Cirques (Sirk)?
A) Wind
B) Glacier
C) River Water
D) Ground Water
ANS: B
Q: The steep-sided, deep, armchair-shaped hollows formed high up in mountains by glacial erosion are called:
A) Horns
B) Cirques (Sirk)
C) Aretes
D) Moraines
ANS: B
Q: The serrated ridges formed by the headward erosion of two adjacent glaciers, often resulting in a knife-edge shape, are called:
A) Cirques
B) Moraines
C) Aretes (Serrated Ridges)
D) Drumlins
ANS: C
Q: Glacial deposits consisting of unsorted material of different sizes, shapes, and composition are collectively called:
A) Eskers
B) Drumlins
C) Kames
D) Moraines
ANS: D
Q: Elongated, streamlined depositional landforms made of glacial till, often described as 'basket of eggs topography', are known as:
A) Moraines
B) Eskers
C) Drumlins
D) Outwash Plains
ANS: C
Q: What is the name given to the deep inlet or narrow valley formed when the sea water floods a glacially eroded U-shaped valley?
A) Estuary
B) Lagoon
C) Fjord
D) Atoll
...
D) Central Africa
ANS: B
Q: A depositional landform created by ground water, hanging from the roof of a cave, is called a:
A) Stalagmite
B) Pillar
C) Column
D) Stalactite
ANS: D
Q: A depositional landform created by ground water, rising from the floor of a cave, is called a:
A) Stalactite
B) Stalagmite
C) Pillar
D) Speleothem
ANS: B
Q: What term is given to a very large deposit of sand or soil created by wind action, typically found in deserts?
A) Mesas
B) Pediments
C) Dunes
D) Inselbergs
ANS: C
Q: Crescent-shaped sand dunes, which are the most common type, are called:
A) Seif Dunes
B) Parabolic Dunes
...
D) Seif Dunes
ANS: C
Q: The vast sheets of fine silt and clay deposited by wind over large areas, often far from their source, are called:
A) Playas
B) Loess
C) Silt Deposits
D) Pediments
...
D) Glacial
ANS: C
Q: The flat, broad rock surfaces formed in deserts due to intense wind erosion of the base of the rock structure are called:
A) Pediments
B) Pediplains
C) Playas
D) Mesas
ANS: B
Q: Sea wave erosion leads to the formation of vertical cliffs along the coast, which are called:
A) Headlands
B) Bays
C) Sea Caves
D) Sea Cliffs
ANS: D
Q: The large, isolated vertical columns of rock left behind after sea waves erode the surrounding cliff and arch structures are called:
A) Sea Stacks
B) Sea Arches
C) Sea Caves
D) Sea Buttes
ANS: A
Q: A ridge of sand or shingle running parallel to the coast and connected to the mainland at one end is called a:
A) Bar
B) Barrier
C) Spit
D) Lagoon
ANS: C
Q: A depositional feature that connects a mainland to an island is called a:
A) Bar
B) Spit
C) Tombolo
D) Barrier
ANS: C
Q: Which of the following depositional landforms is created by Sea Waves?
A) Stack
B) Cliff
C) Beach
D) Cave
...
D) River valleys
ANS: C
Q: The process of erosion, transportation, and deposition by wind is referred to as:
A) Fluvial process
B) Aeolian process
C) Glacial process
D) Karst process
...
D) Kinetic Energy
ANS: D
Q: The two stages in the life cycle of a river immediately following the Youthful stage are:
A) Old and Delta
B) Mature and Old
C) Plateau and Plain
D) Canyon and Gorge
...
[SUBJECT: Geography]
[CHAPTER: Atmosphere]
Q: Atmosphere is primarily held in place around the Earth by:
...
ANS: C
Q: The primary source of the new atmospheric gases (Water Vapour, CO2, etc.) that formed the secondary atmosphere was:
A) Solar Wind Absorption
...
D) Thermal Gradient
ANS: C
Q: The normal rate of temperature decrease in the Troposphere is approximately:
A) 1°C per 100 meters
B) 6.5°C per 1 kilometer
C) 1°C per 1 kilometer
D) 1°F per 165 meters
ANS: B
...
D) Daytime heating and low atmospheric pressure
ANS: B
Q: Temperature Inversion causes the atmosphere to become:
A) Unstable, leading to storms and rain
B) Stable, suppressing cloud formation and vertical movement
C) Highly turbulent
...
D) Magnetosphere
ANS: C
Q: The thinning of the Ozone Layer is primarily attributed to the emission of:
A) Carbon Monoxide
B) Methane
C) Chlorofluorocarbons (CFCs)
D) Nitrogen Dioxide
ANS: C
Q: The unit used to measure the thickness of the atmospheric ozone layer is the:
A) Millibar
B) Richter
C) Doppler
D) Dobson Unit
...
D) Horizontal transfer (Advection)
ANS: B
Q: The ratio of the incoming solar radiation that is reflected by a surface to the total incoming radiation is called:
A) Refraction Index
B) Convection Rate
C) Albedo
D) Emissivity
...
D) Forests
ANS: A
Q: The length of the day, Angle of Inclination of the Sun's rays, and Transparency of the Atmosphere are factors that affect:
A) Albedo
B) Lapse Rate
C) Insolation
D) Greenhouse Effect
...
D) The Earth's tilt favors the Tropics.
ANS: C
...
ANS: B
Q: A temperature increase in the Troposphere would lead to:
A) Instability, promoting air mixing and rain
B) Stability, suppressing air mixing and promoting dry weather
C) Increased lapse rate
D) Cloud formation
ANS: A
Q: Which process is responsible for the rapid heating of the air immediately adjacent to the Earth's surface during the day?
A) Convection
B) Advection
C) Conduction
D) Radiation
...
D) Conduction
ANS: D
Q: The primary natural process that drives the long-term changes in the Earth's atmosphere is:
A) Solar Wind Absorption
B) Biological Modification (Photosynthesis)
...
D) Salinity
ANS: B
Q: The phenomenon where an air mass is warmer than the surface below it is a key characteristic of:
A) Normal Lapse Rate
B) Advection
C) Convection
...
D) Humidity
ANS: D
Q: What is the instrument used to measure the humidity (water vapour content) in the air?
A) Hydrometer
B) Barometer
C) Anemometer
D) Hygrometer
ANS: D
Q: The process where liquid water turns into water vapour (gas) due to heat is called:
A) Condensation
B) Sublimation
C) Evaporation
D) Precipitation
ANS: C
Q: The energy added to water at 100°C to turn it into steam (vapour) without changing its temperature is called:
A) Sensible Heat
B) Latent Heat of Vaporization
C) Specific Heat
D) Advective Heat
ANS: B
Q: The process where water vapour (gas) turns back into liquid water is called:
A) Evaporation
B) Condensation
C) Sublimation
D) Precipitation
...
D) Air temperature has no effect on moisture capacity.
ANS: C
Q: The humidity measure calculated by comparing the actual moisture in the air to the maximum moisture the air can hold (capacity) at that temperature is:
A) Absolute Humidity
B) Specific Humidity
C) Relative Humidity
...
D) Lapse Rate
ANS: C
Q: The minute particles around which water vapour condenses to form cloud droplets or fog are called:
A) Aerosols
B) Hydrospheres
...
B) Above 10°C
C) Above 0°C (Freezing Point)
D) Equal to the Freezing Point
ANS: A
Q: The visible mass of tiny water droplets or ice crystals suspended in the atmosphere is called a:
A) Fog
B) Haze
C) Cloud
D) Mist
...
D) Cirrus
ANS: D
Q: The clouds that are layered, sheet-like, and cover large portions of the sky (often associated with light drizzle) are called:
A) Cirrus
B) Cumulus
C) Stratus
D) Nimbus
...
D) Fog is composed of ice crystals, while mist is water droplets.
ANS: A
Q: What is the term for the condensation product formed when smoke particles act as hygroscopic nuclei?
A) Mist
B) Dew
C) Smog
D) Vog
ANS: C
Q: Which phenomenon is created when the latent heat of condensation is released high in the atmosphere?
A) Stability in the atmosphere
B) Heating of the surrounding air
...
D) Precipitation
ANS: D
Q: Which form of precipitation is characterized by the formation of ice crystals when the dew point is below freezing point?
A) Rain
B) Sleet
C) Snow
D) Hail
...
ANS: B
Q: Which form of precipitation refers to the simple fall of liquid water droplets that have condensed from water vapour?
A) Sleet
B) Snow
C) Mist
D) Rain
...
D) Ozone
ANS: B
Q: Artificial rain (cloud seeding) is often used in polluted cities to:
A) Increase the relative humidity.
B) Clear the pollution by washing suspended particles out of the air.
...
D) To absorb more solar radiation.
ANS: A
Q: The formation of dew and fog is an example of condensation occurring:
A) Only at high altitudes
B) Only on hygroscopic nuclei
...
D) Rainfall
ANS: C
Q: The primary driving force that causes water droplets/ice crystals to eventually fall as precipitation is:
A) Coriolis Force
B) Centrifugal Force
C) Latent Heat
D) Gravity
...
D) Stratus
ANS: C
Q: The low-lying clouds that cover the sky in layers are known as:
A) Cumulus
B) Stratus
C) Altostratus
D) Cirrus
...
D) Is always static
ANS: B
Q: Winds that blow consistently throughout the year, covering large areas of the planet (e.g., Trade Winds, Westerlies), are called:
A) Local Winds
B) Planetary (Permanent) Winds
C) Periodic Winds
D) Mountain Winds
ANS: B
Q: Winds that blow over a small, specific area for a short duration, caused by local differences in geography or temperature (e.g., Loo), are called:
A) Permanent Winds
B) Trade Winds
C) Local Winds
D) Westerlies
...
D) Monsoon Winds
ANS: C
Q: The convergence zone near the Equator where the North-East and South-East Trade Winds meet is called the:
A) Horse Latitudes
B) Doldrums
...
D) East in the Westerlies zone.
ANS: C
Q: The belt of calm, ascending air at the Equator, located within the ITCZ (Inter-Tropical Convergence Zone), is known as the:
A) Horse Latitudes
B) Doldrums
C) Polar Front
D) Sub-Polar Low
...
D) Dry winds
ANS: C
Q: The wind that descends the Alps and is known for causing rapid warming in the valleys, accelerating the ripening of grapes, is the:
A) Chinook
B) Foehn
C) Mistral
D) Bora
...
D) Geostrophic Wind
ANS: D
Q: Which statement correctly describes the relationship between air temperature and pressure?
A) Warm air is associated with high pressure.
B) Cold air is associated with low pressure.
C) Warm air is associated with low pressure.
D) Air temperature has no relation to pressure.
ANS: C
Q: The phenomenon where a dry, cold wind blows down a mountain, caused by dense air sinking rapidly (e.g., the Bora), is called:
A) Anabatic Wind
B) Katabatic Wind
C) Chinook Wind
D) Sea Breeze
ANS: B
Q: The strong winds in the Southern Hemisphere at the 50° latitude are known as:
A) Shrieking Sixties
B) Roaring Forties
C) Furious Fifties
D) Polar Westerlies
...
ANS: B
Q: Which local wind is known for its extreme coldness and is found in Siberia and Central Asia?
A) Buran
B) Mistral
C) Foehn
D) Chinook
ANS: A
Q: The wind that causes the least deflection due to the Coriolis Force is located near the:
A) Poles (90°)
B) Mid-latitudes (45°)
C) Tropics (23.5°)
D) Equator (0°)
...
D) Autumn
ANS: B
Q: The surface winds blowing from the Sub-Tropical High to the Sub-Polar Low are:
A) Trade Winds
B) Polar Easterlies
C) Westerlies
D) Jet Streams
...
D) South-to-North
ANS: B
Q: The central, calm, and cloud-free area of a mature cyclone, where air is sinking, is known as the:
A) Eye Wall
B) Eye
C) Cumulonimbus Top
D) Pressure Ridge
ANS: B
Q: The most destructive part of a cyclone, characterized by intense winds and heavy rainfall from towering cumulonimbus clouds, is the:
A) Outer Rainbands
B) Eye
C) Eye Wall
D) Central Core
...
ANS: B
Q: The boundary created when a warm air mass and a cold air mass meet, often leading to rainfall in mid-latitudes, is called a:
A) Trough
B) Front (Vaatagra)
C) Ridge
D) Sub-Tropical High
...
D) Somali Current
ANS: B
Q: The large systems of rotating ocean currents, often observed in the mid-latitudes, which trap large masses of seaweed, are called:
A) Thermoclines
B) Ocean Trenches
C) Gyres
D) Counter Currents
ANS: C
Q: The central area of the North Atlantic Gyre, known for its calm conditions and dense seaweed mats, is called the:
A) Horse Latitudes
B) Doldrums
C) Sargasso Sea
D) Norwegian Sea
ANS: C
Q: A narrow zone in the ocean where temperature rapidly decreases with depth is called a:
A) Halocline
B) Isonef
C) Pycnocline
D) Thermocline
ANS: D
Q: A narrow zone in the ocean where salinity (saltiness) rapidly increases with depth is called a:
A) Thermocline
B) Halocline
C) Pycnocline
D) Bathythermograph
...
D) All of the above
ANS: D
Q: India's total geographical area constitutes approximately what percentage of the world's total area?
A) 1.5%
B) 2.4%
C) 3.2%
D) 5.1%
...
[SUBJECT: Geography]
[CHAPTER: The Great Indian Himalayas]
...
D) Nepal
ANS: B
Q: The Brahmaputra River enters India after making a famous U-turn around which Himalayan peak?
A) Kanchenjunga
B) Mount Everest
C) Nanga Parbat
D) **Namcha Barwa**
...
ANS: B
Q: The largest right-bank tributary of the Yamuna River is the:
A) Sone River
B) Ken River
C) Betwa River
D) **Chambal River**
...
D) Coastal deltas
ANS: B
Q: The major right-bank tributary of the Ganga (Padma in Bangladesh) that branches out near Farakka (West Bengal) is the:
A) Yamuna
B) Sone
C) Gandak
...
ANS: A
Q: The geological term for a large mass of intrusive igneous rock that has cooled beneath the surface, often exposed by subsequent erosion, is a:
A) Dyke
B) Sill
C) Laccolith
D) **Batholith**
